...
export type CreateGatewayRequest = Partial<Omit<Gateway, 'devices'> & {devices: string[]}>

export type CreateGatewayResponse = Gateway

export type CreateGatewayParams = Record<string, never>;

export type PatchGatewayRequest = Partial<Omit<Gateway, 'devices'> & {devices: string[]}>
